...
const { getCaHoc, createCaHoc, updateCaHoc, xoaCaHoc, exportCaHocToExcel  } = require('../controllers/caHocController');
...
router.get('/xuat-cahoc', authMiddleware(2), exportCaHocToExcel);
