  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: any, record: LopHocTypeWithMax) => (
        <Link to={`/nhapdiem/${record.maLopHoc}`}>Nhập điểm</Link>
      ),
    },
  ];
  ...
  return (
    <div>
      <div className="search-header">
        <h1 className="page-name">DANH SÁCH LỚP NHẬP ĐIỂM</h1>
      </div>
