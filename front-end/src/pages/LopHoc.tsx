...
const initialData: LopHocType[] = [
  { key: '1', maLopHoc: 'LH001', tenLopHoc: 'Lớp A', maMonHoc: 'MH001', maGiangVien: 'GV001', ngayBatDau: moment('2023-09-22').format('DD/MM/YYYY'), soLuong: '30', trangThai: 'Còn trống', ghiChu: '', },
  ...
  { key: '6', maLopHoc: 'LH003', tenLopHoc: 'Lớp Toán 12A', maMonHoc: 'MH001', maGiangVien: 'GV001', ngayBatDau: moment('2024-01-10').format('DD/MM/YYYY'), soLuong: '30', trangThai: 'Hoạt động', ghiChu: '', },
  { key: '7', maLopHoc: 'LH004', tenLopHoc: 'Lớp Lý thuyết đồ thị', maMonHoc: 'MH002', maGiangVien: 'GV002', ngayBatDau: moment('2024-02-12').format('DD/MM/YYYY'), soLuong: '25', trangThai: 'Hoạt động', ghiChu: '', },
  { key: '8', maLopHoc: 'LH005', tenLopHoc: 'Lớp Giải tích 11B', maMonHoc: 'MH003', maGiangVien: 'GV001', ngayBatDau: moment('2024-03-15').format('DD/MM/YYYY'), soLuong: '28', trangThai: 'Hoạt động', ghiChu: 'Ghi chú về lớp', },
  ...
  { key: '10', maLopHoc: 'LH007', tenLopHoc: 'Lớp Lập trình C cơ bản', maMonHoc: 'MH005', maGiangVien: 'GV004', ngayBatDau: moment('2024-05-01').format('DD/MM/YYYY'), soLuong: '20', trangThai: 'Hoạt động', ghiChu: '', },
];
